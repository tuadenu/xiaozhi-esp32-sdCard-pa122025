...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* CONNECTED_TO = "Phuong Anh đã kết nối đến ";
        constexpr const char* CONNECTING = "Phuong Anh đang kết nối..";
        constexpr const char* CONNECTION_SUCCESSFUL = "Kết nối thành công";
        constexpr const char* CONNECT_TO = "Phuong Anh kết nối đến ";
        ...
        constexpr const char* LISTENING = "Lắng nghe...";
        ...
        constexpr const char* VERSION = "Phuong Anh A.I ";
